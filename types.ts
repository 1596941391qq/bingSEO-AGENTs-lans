...
export const STORAGE_KEYS = {
  TASKS: 'bing_seo_tasks',
  ARCHIVES: 'bing_seo_archives',
  BATCH_ARCHIVES: 'bing_seo_batch_archives',
  DEEPDIVE_ARCHIVES: 'bing_seo_deepdive_archives',
  WORKFLOW_CONFIGS: 'bing_seo_workflow_configs',
} as const;
