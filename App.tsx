...
const TEXT = {
  en: {
    ...
    serpEvidence: "Top 3 Bing Search Results",
  ...
  return (
    <div
      className={`rounded-lg p-3 font-mono text-xs h-full overflow-hidden flex flex-col shadow-inner ${
        isDarkTheme
          ? "bg-[#0a0a0a] text-blue-400 border border-white/10"
                      ...
                      {editingNodeId === node.id ? (
                        <div className="space-y-2">
                          <textarea
                            ...
                            className={`w-full h-32 p-2 text-xs font-mono border rounded focus:outline-none focus:ring-2 ${
                              isDarkTheme
                                ? "border-blue-500/30 bg-black/60 text-white placeholder:text-slate-500 focus:ring-blue-500/50"
                                : "border-blue-300 bg-white text-gray-900 placeholder:text-gray-400 focus:ring-blue-500"
                            }`}
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="px-3 py-1 bg-blue-500 text-black rounded text-xs hover:bg-blue-600"
                            >
                              {t.close}
                            </button>
                            <button
                        ...
                        <div
                          ...
                          className={`mt-2 p-2 border rounded cursor-pointer transition-colors ${
                            isDarkTheme
                              ? "bg-black/60 border-blue-500/30 hover:border-blue-400"
      ...
      <div className="border-t border-blue-500/20 pt-4 space-y-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-black rounded hover:bg-blue-600 text-sm font-medium"
          >
            ...
            <div className="space-y-2 max-h-32 overflow-y-auto custom-scrollbar">
              {workflowConfigs.map((config) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    {currentConfig?.id === config.id && (
                      <span className="text-xs bg-blue-500/30 text-blue-400 px-2 py-1 rounded">
                        {t.currentlyUsing}
                      </span>
                    )}
                    <button
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {report.longTailKeywords_trans?.map((kw, i) => (
                    <span
                      key={i}
                      className="px-2 py-1 bg-blue-50 border border-blue-100 text-blue-700 rounded text-xs font-medium"
                    >
                      {kw}
                    </span>
                  ))}
          ...
          >
            <div className="flex gap-2">
              <textarea
                ...
                rows={3}
                className={`flex-1 px-3 py-2 rounded-lg border resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  isDarkTheme
  ...
  const getTaskIcon = (task: TaskState) => {
    ...
    return (
      <Search
        size={14}
        className={
          activeTaskId === task.id ? "text-blue-500" : "text-neutral-600"
        }
      />
    );
  };
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-[9px] text-blue-500 font-bold tracking-tight uppercase mt-1">
              Bing SEO Agent
            </p>
          </div>
        </div>
            ...
            {tasks.map((task) => (
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  {activeTaskId === task.id && (
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(16,185,129,0.6)]" />
                  )}
                  <button
      ...
      className={`
        ...
        ${
          isActive
            ...
            : "bg-black/40 border-blue-500/10 text-slate-400 hover:bg-black/60 hover:text-blue-400"
        }
      `}
    >
      {/* Task Icon */}
      <TaskIcon
        className={`w-3.5 h-3.5 flex-shrink-0 ${
          isRunning ? "animate-pulse text-blue-400" : ""
        }`}
      />
      ...
      {isEditing ? (
        <input
          ...
          autoFocus
          className="flex-1 bg-transparent outline-none text-xs font-medium border-b border-blue-500/50 text-white"
...
const TaskMenuModal: React.FC<TaskMenuModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-black/90 border border-blue-500/30 rounded-xl p-6 max-w-md w-full mx-4"
        onClick={(e) => e.stopPropagation()}
      >
...
export default function App() {
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem("bing_seo_archives");
      if (saved) {
    ...
    try {
      const savedConfigs = localStorage.getItem("bing_seo_agent_configs");
      if (savedConfigs) {
        setState((prev) => ({
          ...prev,
    ...
    try {
      const oldConfigs = localStorage.getItem("bing_seo_agent_configs");
  ...
  const deleteArchive = (id: string, e: React.MouseEvent) => {
    ...
    localStorage.setItem("bing_seo_archives", JSON.stringify(updated));
  ...
  const deleteBatchArchive = (id: string, e: React.MouseEvent) => {
    ...
    localStorage.setItem("bing_seo_batch_archives", JSON.stringify(updated));
  ...
  const runMiningLoop = async (startRound: number, taskId: string) => {
    ...
    while (!stopMiningRef.current) {
      ...
      try {
        ...
        addLog(
          `[Round ${currentRound}] Analyzing SERP probability (Bing)...`,
          "api",
          taskId
        );
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute(
      "download",
      `bing_seo_${state.seedKeyword}_${Date.now()}.csv`
    );
      ...
      for (let i = 0; i < batchResult.keywords.length; i++) {
        ...
        if (result.topSerpSnippets && result.topSerpSnippets.length > 0) {
          addBatchThought(
            "serp-search",
            result.keyword,
            `Analyzed top ${result.topSerpSnippets.length} search results from Bing`,
        ...
        >
          ...
          <div className="flex items-center space-x-6">
            ...
            {(authenticated || (import.meta.env.DEV && credits)) && (
              <div className="flex items-center space-x-3 bg-blue-500/5 border border-blue-500/10 px-4 py-2 rounded">
                {creditsLoading ? (
                  <>
            ...
            {authLoading ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  href={MAIN_APP_URL}
                  className="text-blue-500 hover:text-blue-400 text-xs font-bold uppercase tracking-widest transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <main className="flex-1 overflow-y-auto bg-grid-40 px-8 py-6">
            ...
            <div className="max-w-6xl mx-auto mt-8 flex-1 w-full">
                ...
                <div className="mb-6 flex justify-center">
                  <div
                    className={`flex items-center gap-2 backdrop-blur-sm px-4 py-2 rounded-full border shadow-sm text-sm font-medium ${
                      isDarkTheme
                        ? "bg-black/40 border-blue-500/30 text-slate-300"
                        : "bg-white border-blue-500/30 text-gray-700"
                    }`}
                  >
                    ...
                    <select
                      ...
                      className={`outline-none text-blue-400 font-bold cursor-pointer border-none ${
              ...
              {activeTab === "mining" && (
                <div className="max-w-3xl mx-auto">
                  {/* Clean Input Design */}
                  <div
                    className={`flex w-full backdrop-blur-sm rounded-lg shadow-lg border overflow-hidden focus-within:ring-2 focus-within:ring-blue-500/50 transition-all ${
                      isDarkTheme
                        ? "bg-black/40 border-blue-500/30"
                        : "bg-white border-blue-500/30"
                    }`}
                  >
                    <div className="flex items-center justify-center pl-4 text-blue-400/60">
                    ...
                    <button
                      ...
                      className="bg-blue-500 hover:bg-blue-600 text-black px-8 font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {t.btnStart}
                    </button>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 border rounded-lg text-sm font-semibold focus:ring-2 focus:ring-blue-500/50 outline-none ${
                            isDarkTheme
                              ? "border-blue-500/30 bg-black/60 text-white"
                              : "border-blue-500/30 bg-white text-gray-900"
                          }`}
                        />
                        <p
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`w-full px-3 py-2 border rounded-lg text-sm font-semibold focus:ring-2 focus:ring-blue-500/50 outline-none cursor-pointer ${
                            isDarkTheme
                              ? "border-blue-500/30 bg-black/60 text-white"
                              : "border-blue-500/30 bg-white text-gray-900"
                          }`}
                        ...
                        >
                          {state.archives.map((arch) => (
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div
                                  className={`p-2 rounded text-blue-400 transition-colors ${
                                    isDarkTheme
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <textarea
                          ...
                          className={`w-full h-32 px-4 py-3 border rounded-lg text-sm outline-none focus:ring-2 resize-none ${
                            isDarkTheme
                              ? "border-blue-500/30 bg-black/60 focus:ring-blue-500/50 text-white placeholder:text-slate-500"
                              : "border-blue-300 bg-white focus:ring-blue-500 text-gray-900 placeholder:text-gray-400"
                          }`}
                        />
                      </div>
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-black px-6 py-3 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <Search className="w-5 h-5" />
                        {t.btnBatchAnalyze}
                      </button>
                        ...
                        className={`flex items-center gap-2 text-xs font-bold px-3 py-1.5 rounded-full border transition-all ${
                          state.showPromptTranslation
                            ? isDarkTheme
                              ...
                              : "bg-blue-100 text-blue-700 border-blue-300"
                            : isDarkTheme
                            ? "bg-black/60 text-slate-400 border-blue-500/20"
                            : "bg-gray-100 text-gray-600 border-blue-200"
                        }`}
                      >
                        ...
                        {state.showPromptTranslation && (
                          <div
                            className={`w-full h-32 p-3 border rounded-md text-sm overflow-y-auto ${
                              isDarkTheme
                                ? "bg-black/60 border-blue-500/30 text-slate-300"
                                : "bg-gray-50 border-blue-200 text-gray-700"
                            }`}
                          >
                            <div
            ...
            <div className="flex-1 flex flex-col h-[calc(100vh-200px)] min-h-[500px] relative">
              ...
              {state.miningSuccess && (
                <div className="absolute inset-0 z-10 bg-black/90 backdrop-blur-sm rounded-xl flex items-start justify-center p-4 pt-8 animate-fade-in overflow-y-auto">
                  <div className="bg-black/80 backdrop-blur-sm rounded-xl shadow-2xl border border-blue-500/30 p-8 max-w-md w-full text-center">
                    ...
                    <div className="bg-black/60 rounded-lg p-4 mb-6 border border-blue-500/20">
                    ...
                    <div className="flex flex-col gap-3">
                      <button
                        onClick={goToResults}
                        className="w-full py-3 bg-blue-500 text-black rounded-lg hover:bg-blue-600 transition-colors font-bold shadow-lg shadow-blue-500/20"
                      >
                        {t.viewResults}
                      </button>
                      <button
                        onClick={continueMining}
                        className="w-full py-3 bg-black/60 text-white border border-blue-500/30 rounded-lg hover:bg-blue-500/10 transition-colors font-medium"
                      >
                        {t.btnExpand}
                      </button>
                    </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white flex items-center gap-2">
                      {t.generating}
                      <span className="text-sm font-normal bg-blue-500/20 px-2 py-0.5 rounded-full text-blue-400">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 ${
                          isDarkTheme
                            ? "border-blue-500/30 bg-black/60 focus:ring-blue-500/50 text-white"
                            : "border-blue-300 bg-white focus:ring-blue-500 text-gray-900"
                        }`}
                      />
                      <p
                        className={`text-xs mt-1 ${
              ...
              <div className="flex flex-col md:flex-row justify-between items-end mb-6 gap-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-black rounded-md hover:bg-blue-600 transition-colors text-sm font-medium"
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium transition-colors border rounded-md ${
                      isDarkTheme
                        ? "text-slate-400 hover:text-blue-400 border-blue-500/30 bg-black/60 hover:bg-blue-500/10"
                        : "text-gray-700 hover:text-blue-600 border-blue-300 bg-white hover:bg-blue-50"
                    }`}
                  >
                    {t.newAnalysis}
                  </button>
                              ...
                              <td className="px-4 py-4 text-right">
                                <div className="flex items-center justify-end gap-3">
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center gap-1 px-2 py-1.5 bg-blue-500/20 text-blue-400 rounded hover:bg-blue-500/30 transition-colors text-xs font-medium border border-blue-500/30"
                                    title={t.verifyBtn}
                                    onClick={(e) => e.stopPropagation()}
                                  >
                                    <ExternalLink className="w-3 h-3" />
                                  ...
                                  <button
                                    ...
                                    className="flex items-center gap-1 px-2 py-1.5 bg-blue-500/20 text-blue-400 rounded hover:bg-blue-500/30 transition-colors text-xs font-medium"
                                    title={t.deepDive}
                                  >
          ...
          {state.step === "deep-dive-analyzing" && (
            <div className="flex-1 flex flex-col h-[calc(100vh-200px)] min-h-[500px] relative">
              ...
              {/* Progress Bar */}
              <div className="mb-6 bg-black/40 backdrop-blur-sm rounded-xl shadow-sm border border-blue-500/20 p-6">
                                            ...
                                            {data.serpResults
                                              ...
                                              .map((result, ridx) => (
                                                ...
                                                >
                                                  ...
                                                  <div className="text-blue-700 text-[10px] truncate mt-1">
                                                    {result.url}
                                                  </div>
                  ...
                  >
                    ...
                    <select
                      ...
                      className={`border rounded px-2 py-1 outline-none focus:ring-1 ${
                        isDarkTheme
                          ? "bg-black/60 border-blue-500/30 focus:ring-blue-500/50 text-white"
                          : "bg-white border-blue-300 focus:ring-blue-500 text-gray-900"
                      }`}
                    >
                      <option
